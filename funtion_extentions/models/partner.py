...
class ResPartner(models.Model):
     ...
     x_cliente_contact = fields.Many2many('res.reference', 'partner_id', 'Contacts', 'Reference to', string="Reference for", tracking=True)
     x_cliente_agent = fields.Many2many('res.users', string='Agent to Working', domain="[('share', '=', False)]", string="Agent", tracking=True)
